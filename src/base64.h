...
// ^ Actually that copyright is shown below, but this amalgamation was put together by me
...
// After adding these, I discovered mongoose comes with b64 implementations already.
// I sure hope these ones are faster! :D
